  ...
  return (
    <Accordion.Item value={value} className="border-b border-site-shell-border">
      <Accordion.Header className="m-0">
        <Accordion.Trigger className="w-full flex items-center justify-between p-3 border-0 bg-transparent font-[inherit] text-[13px] font-medium tracking-normal text-left text-site-fg cursor-pointer select-none">
          <span>{title}</span>
          <RiArrowDownSLine
