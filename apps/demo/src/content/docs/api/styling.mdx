...
| `data-resize-active`        | `.tilery__divider, .tilery__junction`            | Set while the resize control is being dragged                  |
| `data-resize-disabled`      | `.tilery__divider, .tilery__junction`            | Set when the resize control cannot resize its adjacent panels  |
