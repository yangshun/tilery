...
Snapshots store the panel tree, tab order, active tabs, fullscreen state, default sizes, size constraints, explicit behavior booleans, floating bounds, popout window bounds, and z-order.
