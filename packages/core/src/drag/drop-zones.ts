...
/**
 * Compute the pixel rect of the visual split-preview half that would be
 * created by dropping into `zone` on `panelRect`. Returns the half of the
 * panel the new split would occupy.
 */
