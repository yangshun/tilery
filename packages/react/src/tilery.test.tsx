...
describe('Tilery — rendering', () => {
  ...
  it('renders pinned edge panels outside the main tiled layer', () => {
    ...
    expect(explorer.style.top).toBe('0%');
    expect(explorer.style.bottom).toBe('0%');
    expect(inspector.style.width).toBe('18%');
    expect(inspector.style.top).toBe('0%');
    expect(inspector.style.bottom).toBe('0%');
    expect(topTools.style.height).toBe('10%');
    expect(topTools.style.left).toBe('22%');
    expect(topTools.style.right).toBe('18%');
    expect(terminal.style.height).toBe('30%');
    expect(terminal.style.left).toBe('22%');
    expect(terminal.style.right).toBe('18%');
