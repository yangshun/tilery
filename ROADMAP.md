...
| P1       | Resize handle states and hit targets    | `react-resizable-panels`, Allotment                                                              | Partial       | `data-resize-active`, `data-resize-at-min`, `data-resize-at-max`, and `resizeHandleHitSize` exist. Add disabled state with resize disabling/locking, and decide whether hover/focus need attributes beyond CSS. |
